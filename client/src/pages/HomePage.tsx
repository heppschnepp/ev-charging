        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between gap-2.5 mb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h1 className="font-bold text-gray-900 dark:text-gray-100 leading-none text-lg">EV Charging Finder</h1>
                <p className="text-xs text-gray-400 dark:text-gray-500 leading-none mt-0.5">Powered by Open Charge Map</p>
              </div>
            </div>
